...
async function geninfo(event, api) {
    ...
    if (input.startsWith("geninfo")) {
        ...
        if (inputArr.length > 1 && inputArr[1] == "-help") {
            ...
            const note =
                "Note: The country code should be an ISO 3166-1 alpha-2 country code. If no country code is provided, the default country is set to US.\n\n" +
