...
async function processBesCommand(event, api, userMessages, userName, replyMessage) {
    ...
    if (data.length < 2) {
        const responses = ["uy bes bakit miss munanaman ako? 😏", "nandito lang ako para sa'yo, bes. 😊", "may kailangan ka ba, bes? 😁", "kumusta araw mo, bes? 😄", "miss mo ba ako, bes? 😅", "bakit bes liligawan mona ako? 😨"];
