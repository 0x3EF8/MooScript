...
async function nxai(event, api) {
    ...
    The data available to you is encapsulated in ${JSON.stringify(
        Data,
        null,
        2
    )}. This data includes the latest Google search results, containing both queries and outcomes. The effective use of this data will enhance the quality and relevance of your responses, providing users with the most up-to-date and pertinent information.
    ...
    `,
                ...
                max_tokens: 2048, // Limit the response length to a reasonable size

                top_p: 0.9, // Maintain diversity in the responses

                frequency_penalty: 0.6, // Slightly increase the penalty for more common phrases

                presence_penalty: 0.6, // Slightly increase the penalty to reduce repetition
            });
